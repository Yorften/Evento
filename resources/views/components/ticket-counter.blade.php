<div>
    <div class="relative flex items-center max-w-[8rem]">
        ...
        @if ($max < 20)
            <input type="text" name="tickets" id="quantity-input" data-input-counter-min="0"
                data-input-counter-max="{{ $max }}" data-input-counter
        ...
        @else
            <input type="text" name="tickets" id="quantity-input" data-input-counter-min="0"
                data-input-counter-max="20" data-input-counter aria-describedby="helper-text-explanation"
                class="bg-gray-50 border-x-0 border-gray-300 h-11 text-center text-gray-900 text-sm focus:ring-blue-500 focus:border-blue-500 block w-full py-2.5"
                placeholder="0" />
        @endif
