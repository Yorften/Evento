    ...
    <div id="crud-modal" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative p-4 w-full max-w-md max-h-full">
            ...
            <div class="relative bg-white rounded-lg shadow">
                ...
                <!-- Modal body -->
                <form class="p-4 md:p-5" method="post" action="{{ route('events.store') }} "
                    ...
                    <div class="grid gap-6 mb-4 grid-cols-2">
                        ...
                        <div class="col-span-2">
                            ...
                            <select name="category_id" id="categories" style="width: full;"
                        ...
                        <div class="col-span-2">
                            <label for="capacity"
                                ...
                                Capacity</label>
                            <input type="number" id="capacity" name="capacity" rows="4"
                                class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
