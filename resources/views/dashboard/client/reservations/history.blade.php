    ...
    <div class="w-11/12 mx-auto flex flex-col items-start justify-start mt-8 text-gray-900">
        <div class="flex items-center flex-wrap">
            <ul class="flex items-center">
                ...
                <li class="inline-flex items-center">
                    <a href="{{ route('reservations.history') }}" class="hover:text-blue-500">Reservations History</a>
                </li>
            </ul>
        </div>
        <div class="w-full flex justify-between items-center px-2 mt-4">
            <p class="text-none text-xl font-semibold indent-4">Reservations History</p>
        </div>
