<x-dashboard-layout>
    <div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 p-4 gap-4">
            ...
            <div
                ...
                <div class="rounded-t mb-0 px-0 border-0">
                    <div class="flex flex-wrap items-center px-4 py-2">
                        <div class="relative w-full max-w-full flex-grow flex-1">
                            <h3 class="font-semibold text-base text-gray-900">Recent Activities
                            </h3>
                        </div>
                        <div class="relative w-full max-w-full flex-grow flex-1 text-right">
                            <button
                    ...
                    <div class="block w-full">
                        ...
                        <ul class="my-1">
                                ...
                                <div
                                    ...
                                    <div class="flex-grow flex justify-between items-center">
                                        <div class="self-center">
                                            <a class="font-medium text-gray-800 hover:text-gray-900"
                            ...
                            <li class="flex px-4">
                                ...
                                <div
                                    class="flex-grow flex items-center border-gray-100 text-sm text-gray-600 py-2">
                                    <div class="flex-grow flex justify-between items-center">
                                        <div class="self-center">
                                            The post <a
                                                class="font-medium text-gray-800"
            ...
            <div class="md:col-span-2 xl:col-span-1">
                <div class="rounded bg-gray-200 p-3">
                    <div class="flex justify-between py-1 text-black">
                        ...
                        <svg class="h-4 fill-current text-gray-600 cursor-pointer"
                    ...
                    <div class="text-sm text-black mt-2">
                        <div
                            class="bg-white hover:bg-gray-50 p-2 rounded mt-1 border-b border-gray-100 cursor-pointer">
        ...
        <div class="mt-8 mx-4">
            <div class="grid grid-cols-1 md:grid-cols-2">
                ...
                <form class="p-6 flex flex-col justify-center">
                    ...
                    <button type="submit"
                        class="md:w-32 bg-blue-600 text-white font-bold py-3 px-6 rounded-lg mt-4 hover:bg-blue-500 transition ease-in-out duration-300">Submit</button>
                </form>
            </div>
        </div>
        <!-- ./Contact Form -->
        ...
        <div class="mt-8 mx-4">
            <div
                class="p-4 bg-blue-50 border border-blue-500 rounded-lg shadow-md">
